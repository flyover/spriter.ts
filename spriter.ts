...
export class Angle {
  ...
  get deg(): number { return this.rad * 180 / Math.PI; }
  set deg(value: number) { this.rad = value * Math.PI / 180; }
  get cos(): number { return Math.cos(this.rad); }
  get sin(): number { return Math.sin(this.rad); }
  selfIdentity(): Angle { this.rad = 0; return this; }
  copy(other: Angle): Angle { this.rad = other.rad; return this; }
  static add(a: Angle, b: Angle, out: Angle = new Angle()): Angle { out.rad = wrapAngleRadians(a.rad + b.rad); return out; }
  add(other: Angle, out: Angle = new Angle()): Angle { return Angle.add(this, other, out); }
  selfAdd(other: Angle): Angle { return Angle.add(this, other, this); }
...
export class Folder extends Element {
  ...
  load(json: any): Folder {
    ...
    json.file.forEach((file_json: any): void => {
...
export class Data {
  ...
  getEntities(): {[key: string]: Entity} { return this.entity_map; }
  getEntityKeys(): string[] { return this.entity_keys; }
